      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-300">Email: info@abrtutors.co.za</li>
              <li className="text-gray-300">Tel: +27 075 1499977</li>
              <li className="mt-4">
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-300 hover:text-amber-200">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-300 text-sm">
            © {new Date().getFullYear()} ABR Tutors. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
